...
This may result in a lower service level for DM development \newtext{but} it probably has no impact on science\newtext{,} except in the realm of reliability\newtext{.}
\oldtext{but we need } \newtext{We are awaiting} the analysis from NCSA.
