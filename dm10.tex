...
especially \oldtext{less capable} \newtext{novice} and casual users.
Hence we would rather keep the portal \oldtext{we have} \newtext{in its current incarnation}, pause development, and \newtext{then} restart closer 
...
Given the above we would \oldtext{keep}\newtext{reserve} \$1M for the later development of an updated portal for DR1
...
An LCR will provided detailed costings, but \oldtext{intitial} \newtext{initial} estimates are that this will save at least \$2M.
